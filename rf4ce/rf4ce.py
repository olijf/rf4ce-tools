...
class Rf4ceConstants(object):
	...
	COMMAND_DISCOVERY_REQUEST=0x01
	COMMAND_DISCOVERY_RESPONSE=0x02
	COMMAND_PAIR_REQUEST=0x03
	COMMAND_PAIR_RESPONSE=0x04
	COMMAND_UNPAIR_REQUEST=0x05
	COMMAND_KEY_SEED=0x06
	COMMAND_PING_REQUEST=0x07
	COMMAND_PING_RESPONSE=0x08
